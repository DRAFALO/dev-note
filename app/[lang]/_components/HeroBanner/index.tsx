    ...
    <section className='container'>
      <div className=' grid grid-cols-2 gap-4 bg-slate-200'>
        <div className='flex flex-col gap-4 px-12 py-[5rem]'>
          <AppLink
            href='/'
            aria-label={dictionary['DevNote is a blog that helps you to share your knowledge.']}
          >
            <h2 className='text-heading-1'>
              {dictionary['DevNote is a blog that helps you to share your knowledge.']}
            </h2>
          </AppLink>
          ...
          <p className='line-clamp-3'>
            ...
            available. Beautifully crafted with the latest technologies, SASS & Bootstrap 4.1.3,
            Mundana is the perfect design for your professional blog. Homepage, post article and
            category layouts available.
          </p>
